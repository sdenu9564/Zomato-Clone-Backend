...
exports.payments = (req, res) => {
    ...
    const PAYTM_MERCHANT_KEY="@CFkvt#nJLF3Rjr7";
    var params = {};
    ...
    params['MID'] = process.env.PAYTM_MID,
        ...
        params['CALLBACK_URL'] = 'http://localhost:9564/callback',
        params['EMAIL'] = email,
    ...
    */
    var paytmChecksum = PaytmChecksum.generateSignature(params,PAYTM_MERCHANT_KEY);
